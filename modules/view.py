...
class View(commands.Cog):
    ...
    @commands.slash_command(name='cmarchive', description='Shorthand for /view')
    ...
    @commands.slash_command(name='viewarchive', description='View a specific character by ID.')
